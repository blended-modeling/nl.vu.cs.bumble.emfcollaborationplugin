...
//	public final static class ExampleModelServerClient {
	         ...
	         while (!input.contentEquals(CMD_QUIT)) {
	            ...
	            try {
	               ...
	               if (command.contentEquals("1")) {
	                  handleSubscribe(client, new String[] { CMD_SUBSCRIBE, STATEMACHINE_XMI, FORMAT_JSON_V2 });
	               } else if (command.contentEquals("2")) {
	                  handleSubscribe(client, new String[] { CMD_SUBSCRIBE, STATEMACHINE_ECORE, FORMAT_JSON_V2 });
	               } else if (command.contentEquals("3")) {
	                  handleUnsubscribe(client, new String[] { CMD_UNSUBSCRIBE, STATEMACHINE_XMI });
	               } else if (command.contentEquals("4")) {
	                  handleUnsubscribe(client, new String[] { CMD_UNSUBSCRIBE, STATEMACHINE_ECORE });
	   ...
	   public static void handleRegisterEcore(final String[] commandAndArgs)
	   ...
	   public static void handleRedo(final ModelServerClient client, final String[] commandAndArgs)
	      throws InterruptedException, ExecutionException, TimeoutException {
	      Response<String> response = client.redo(commandAndArgs[1]).join();
	      System.out.println("< " + toString(response));
	   }

	   public static void handleUndo(final ModelServerClient client, final String[] commandAndArgs)
	      throws InterruptedException, ExecutionException, TimeoutException {
...
//	         CommandUtil.createProxy(StatemachinePackage.Literals.STATE_MACHINE,   .WORKFLOW, "SuperBrewer3000.coffee#//@workflows.0"),
//	         EcorePackage.Literals.ENAMED_ELEMENT__NAME,
//	         commandAndArgs[1]);
//	      Response<String> response = client.edit(STATEMACHINE_XMI, command, FORMAT_JSON_V2).join();
//	      System.out.println("< " + toString(response));
//	   }

	   public static void handleUpdateTasks(final ModelServerClient client, final String[] commandAndArgs)
	      throws InterruptedException, ExecutionException, TimeoutException {
	   ...
	   public static void handleGet(final ModelServerClient client, final String[] commandAndArgs)
	   ...
	   public static void handleGetAll(final ModelServerClient client, final String[] commandAndArgs)
	      throws InterruptedException, ExecutionException, TimeoutException, IOException {
	   ...
	   public static void handleSubscribe(final ModelServerClient client, final String[] command)
	   ...
	   public static void handleUnsubscribe(final ModelServerClient client, final String[] command)
	      throws InterruptedException {
	      String modelUri = command.length >= 1 ? command[1] : "";
	   ...
	   public static void handlePing(final ModelServerClient client)
	      throws InterruptedException {
	...
	public JsonPatch notifyServer(ENotificationImpl notification) throws MalformedURLException {
